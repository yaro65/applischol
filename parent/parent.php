...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="ajouterpa.php" method="POST">
         ...
         <div class="form-group mt-3">
                <input type="email" name="email"  class="form-control" placeholder="emaile" required>
            </div>
          
            <div class="form-group  mt-3">
                <input type="posword" name="mp"  class="form-control" placeholder="mot de passe" required>
            </div>
...
foreach ($getParent as $p) {
    ...
    <tr>
        ...
        <td>" . $p['email'] . "</td>
        <td>
            <a onclick ='return popUpDeletecategorie()' href='supprimer.php?ida=" . $p['id'] . "' class='btn btn-danger'>Supprimer</a>
        </td>
    </tr>
    ";
}
