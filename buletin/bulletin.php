...
<link href="../boost/bootstrap.css" rel="stylesheet" >
    <!-- Favicons -->
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="crereb.php" method="POST">
         <input type="hidden" name="id" >
            ...
            <div class="form-group mt-3">
              <select name="classe" class="form-control">
               <?php
                   foreach ($eleve as $index => $e) {
                    echo "<option value='" . $e['classe'] . "'>" . $e['classe'] . "</option>";
                     }
                   ?>
               </select>
            </div>
            ...
            <div class="form-group  mt-3">
                <input type="text" name="moyenne"  class="form-control" placeholder="Moyenne" required>
            </div>
