      ...
      <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto ">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex active align-items-center gap-2 text-dark" href="eleves/eleve.php">
...
if (isset($_GET['ajoute']) && ($_GET['ajoute']) == 'ok'){
  ...
  Secretaire ajouter  avec succes
</div>
  ";
}
?>
...
<?php
      if (isset($_GET['supprime']) && ($_GET['supprime']) == 'ok'){
        echo "
        <div class='alert alert-success'>
        Secretaire supprimer avec succes
      </div>
        ";
      }
      ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">inscrire une secretaire</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="ajouterad.php" method="POST">
         <input type="hidden" name="idc" >

         <div class="form-group mt-3">
                <input type="email" name="email"  class="form-control" placeholder="emaile">
            </div>
          
            <div class="form-group  mt-3">
                <input type="posword" name="mp"  class="form-control" placeholder="mot de passe">
            </div>
...
foreach ($administrat as $a) {
    ...
    <tr>
        ...
        <td>" . $a['nom'] . "</td>
        <td>
            <a onclick ='return popUpDeletecategorie()' href='supprimer.php?ida=" . $a['id'] . "' class='btn btn-danger'>Supprimer</a>
        </td>
    </tr>
    ";
}
