...
<div class="container-fluid">
  <div class="row">
      ...
      <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto ">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 text-dark" href="../stok/listestok.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <?php
      if (isset($_GET['ajoueter']) && ($_GET['ajoueter']) == 'ok'){
        echo "
...
foreach ($eleve as $e) {
    ...
    <tr>
        ...
        <td>
            <a data-bs-toggle='modal' data-bs-target='#editModal" . $e['id'] . "' class='btn btn-success'>Modifier</a>
            <a onclick ='return popUpDeletecategorie()' href='supprimer.php?idc=" . $e['id'] . "' class='btn btn-danger'>Supprimer</a>
        </td>
    </tr>
    ";
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Enregistrer une Eleves</h1>
...
<!-- Modifier -->
<?php
foreach ($eleve as $inde => $eleve){
  ?>
<div class="modal fade" id="editModal<?php echo $eleve['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
         ...
         <input type="hidden" name="idc" value="<?php echo $eleve['id'];?>" >
            <div class="form-group">
                <input type="text" name="nom" value="<?php echo $categorie['nom'];?>" class="form-control" placeholder="Nom de catégorie">
            </div>
            <div class="form-group mt-3">
              <textarea name="description"  class="form-control" placeholder="nom de catégorie" ><?php echo $categorie['description'];?></textarea>
            </div>
